...
export class Service {
    ...
    constructor () {
        ...
        // bucket part can be created in a seperate file for more readability
    ...
    async uploadFile(file) {
        try {
            return await this.bucket.createFile(conf.appwriteDatabaseId, conf.appwriteCollectionId, ID.unique(), file)
        } catch (error) {
